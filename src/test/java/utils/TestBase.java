    ...
    public WebDriver WebDriverManager() throws IOException {
        ...
        if (driver == null) {
            if (browser != null && browser.equalsIgnoreCase("chrome")) {
                ...
                try {
                    // Замяна на локалния ChromeDriver с RemoteWebDriver за използване със Selenium Grid
                ...
                try {
                    // Замяна на локалния FirefoxDriver с RemoteWebDriver за използване със Selenium Grid
                    driver = new RemoteWebDriver(new URL("http://172.17.0.3:4444/wd/hub"), options);
                } catch (MalformedURLException e) {
                    e.printStackTrace();
                }
